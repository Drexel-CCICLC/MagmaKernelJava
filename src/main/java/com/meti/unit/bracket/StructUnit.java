...
public class StructUnit implements CompoundUnit {
	...
	private Optional<Type> resolveStructType(String value, ComplexCompiler compiler) {
	...
	private Type parseReturnType(String value, ComplexCompiler compiler) {
	...
	private List<Type> paramTypeString(String value, ComplexCompiler compiler) {
	...
	private List<Type> collectTypes(ComplexCompiler compiler, String paramString) {
	...
	private Type resolveTypeName(ComplexCompiler compiler, String paramString) {
	...
	private void append(String value, ComplexCompiler compiler, String name) {
		int index = index(value);
	...
	private String buildHeader(String name, String value, ComplexCompiler compiler) {
	...
	private String parseParams(String value, ComplexCompiler compiler) {
		int start = value.indexOf('(');
		int end = value.indexOf(')');
	...
	private String parseParamString(String paramsString, ComplexCompiler compiler) {
	...
	private String buildParamString(String param, ComplexCompiler compiler) {
